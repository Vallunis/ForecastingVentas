...
df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       ...
       'ingresos', 'dia_semana', 'nombre_dia', 'año', 'mes', 'dia_mes',
       'es_fin_semana', 'es_festivo', 'es_BlackFriday', 'es_cyber_monday',
       'trimestre', 'semana_año', 'es_laborable', 'es_inicio_mes',
       'es_fin_mes', 'unidades_vendidas_lag_1', 'unidades_vendidas_lag_2',
